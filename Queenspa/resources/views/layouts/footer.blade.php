      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-4 hidden-xs">
          <div class="footer-widget">
            ...
            <div class="widget-content">
                <iframe src="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2FtrungtamchamsocsacdepQUEENBEAUTYNeo&width=500&show_text=true&height=202&appId" width="500" height="202" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow=" picture-in-picture"></iframe>            </div>
          </div>
        </div>
      </div>
    </div>
